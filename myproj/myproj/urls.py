...
urlpatterns = patterns('',
    ...
    url(r'^addlang/$', 'myapp.views.addlang'),
    url(r'^addint/$', 'myapp.views.addint'),
    url(r'^addloc/$', 'myapp.views.addloc'),
    ...
    url(r'^removefriend/(?P<user_id>\d+)/$', 'myapp.views.removefriend', name='removefriend'),
